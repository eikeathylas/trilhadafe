  ...
  $.extend(Selectize.prototype, {
    ...
    setup: function () {
      ...
      $wrapper = $("<div>")
        ...
        .addClass(inputMode);
      $control = $("<div>")
        .addClass(settings.inputClass + " selectize-input items")
        .appendTo($wrapper);
      $control_input = $('<input type="select-one" autocomplete="new-password" autofill="no" />')
        .appendTo($control)
      ...
      $dropdown_content = $("<div>")
        .addClass(settings.dropdownContentClass + " selectize-dropdown-content")
        .attr("tabindex", "-1")
        .appendTo($dropdown);
