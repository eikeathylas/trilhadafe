    ...
    <div class="main-only px-0 px-md-3">
                ...
                <div class="row g-2 g-md-3 align-items-end">
                    ...
                    <div class="col-12 col-md-auto d-grid mt-3 mt-md-0">
                        <div class="d-flex justify-content-center gap-2 h-100">
                            <button class="btn btn-light fw-bold shadow-sm d-flex align-items-center justify-content-center transition-all hover-bg-light" onclick="loadUsuarios()" title="Recarregar Lista" style="height: 48px; border-radius: 12px; min-width: 160px;">
        ...
        <div class="card list-commanded mb-0 mb-md-4 border-0 shadow-none shadow-md-sm rounded-sm-0 rounded-md-4">
            <div class="card-body p-0 pt-md-4 px-md-0">
                ...
                <div
                    class="pagination paginationButtons pagination-usuarios mt-3 pb-4 pb-md-0 text-center justify-content-center">
                </div>
            </div>
        </div>
            ...
            <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden bg-transparent-card">
                        ...
                        <div class="card border-0 rounded-4 bg-danger bg-opacity-10 p-4 border-start border-4 border-danger transition-all hover-bg-light"
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                                ...
                                <button type="button" class="btn btn-danger fw-bold shadow-sm rounded-pill px-4 transition-all hover-scale"
                                    onclick="resetPassword(this)" style="height: 48px;">
                ...
                <div class="modal-footer border-0 p-2 bg-transparent align-items-center">
                    <button type="button" class="btn btn-light fw-bold px-4 rounded-4 border shadow-sm transition-all hover-bg-light me-2"
                        data-bs-dismiss="modal" style="height: 48px;">Fechar</button>
