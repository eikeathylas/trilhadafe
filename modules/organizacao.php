                    ...
                    <div class="p-4">
                        <div class="row g-4">
                            <div class="col-12 col-md-3 d-flex flex-column align-items-center">
                                ...
                                <div id="image-upload-container-org" class="border border-2 border-secondary border-opacity-25 p-1 rounded-circle bg-secondary bg-opacity-10 position-relative shadow-sm transition-all" style="cursor: pointer; width: 160px; height: 160px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-danger mt-3 rounded-pill px-3 d-none fw-medium" id="btn-remove-logo" onclick="removeLogoOrg()">
