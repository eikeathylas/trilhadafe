...
# 📅 Tela: Calendário (antiga Agenda)

## [ ] Alterar nome **Agenda / Agenda e Eventos → Calendário**

**Objetivo**

Padronizar o nome da tela para algo mais claro e moderno.
...
- Título da página
- Breadcrumbs
- Possíveis referências internas

---

## [ ] Ajustar exibição do dia da semana

**Objetivo**

Substituir o texto fixo **"DIA"** pela abreviação real do dia da semana com base na data do evento.

**Comportamento esperado**

O sistema deve calcular automaticamente o dia da semana a partir da data.
